...
image_roberts = det.my_roberts(det.spremeni_kontrast(image, 4, 0))
cv.imwrite("./images/image_roberts.jpg", det.spremeni_kontrast(image_roberts, 5, 0)) # povečamo kontrast za boljšo vidljivost robov
# show_one("roberts", image_roberts)
# show_compare("Base", "Roberts cross", image, image_roberts)

image_prewitt = det.my_prewitt(image)
cv.imwrite("./images/image_prewitt.jpg", det.spremeni_kontrast(image_prewitt, 2, 0))
